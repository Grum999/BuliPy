...
class WImageFilePreview(QWidget):
    """An advanced interface to display image file preview
    ...
    def __init__(self, parent=None):
        super(WImageFilePreview, self).__init__(parent)

        uiFileName = os.path.join(os.path.dirname(__file__), '..', 'resources', 'wimagefilepreview.ui')
    ...
    def showPreview(self, img=None):
        ...
        Given `img` is QImage or QPixmap
        """
